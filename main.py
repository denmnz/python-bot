...
BOT_TOKEN = "6438348154:AAHbdMJ-aFH3_lPHsiSL3E77hYyl-rg0SS8"
PAYMENT_CHANNEL = "@genmnzc" #add payment channel here including the '@' sign
OWNER_ID = 6438348154 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@genmnzc"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
